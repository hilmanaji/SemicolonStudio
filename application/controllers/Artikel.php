...
class Artikel extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->template->back_end('back_end/v_dashboard');
    }

    public function form()
    {
        
        $this->template->back_end('back_end/v_form');
    }

    public function table()
    {
        
        $this->template->back_end('back_end/v_table');
    }
    ...
    public function kategori()
    {
        ...
        // $this->template->back_end('back_end/v_data_artikel', $data);
        $this->template->back_end('back_end/v_kategori');
    }
